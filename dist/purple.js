...
function oe() {
  if (MA)
    return j;
  MA = 1;
  var Q = wA, l = Symbol.for("react.element"), f = Symbol.for("react.fragment"), B = Object.prototype.hasOwnProperty, O = Q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Z = { key: !0, ref: !0, __self: !0, __source: !0 };
  function z(x, o, M) {
    var C, d = {}, h = null, Y = null;
    M !== void 0 && (h = "" + M), o.key !== void 0 && (h = "" + o.key), o.ref !== void 0 && (Y = o.ref);
    for (C in o)
      B.call(o, C) && !Z.hasOwnProperty(C) && (d[C] = o[C]);
    if (x && x.defaultProps)
      for (C in o = x.defaultProps, o)
        d[C] === void 0 && (d[C] = o[C]);
    return { $$typeof: l, type: x, key: h, ref: Y, props: d, _owner: O.current };
  }
  return j.Fragment = f, j.jsx = z, j.jsxs = z, j;
}
var T = {};
/**
 * @license React
...
function ce() {
  return bA || (bA = 1, process.env.NODE_ENV !== "production" && function() {
    var Q = wA, l = Symbol.for("react.element"), f = Symbol.for("react.portal"), B = Symbol.for("react.fragment"), O = Symbol.for("react.strict_mode"), Z = Symbol.for("react.profiler"), z = Symbol.for("react.provider"), x = Symbol.for("react.context"), o = Symbol.for("react.forward_ref"), M = Symbol.for("react.suspense"), C = Symbol.for("react.suspense_list"), d = Symbol.for("react.memo"), h = Symbol.for("react.lazy"), Y = Symbol.for("react.offscreen"), eA = Symbol.iterator, zA = "@@iterator";
    function WA(A) {
    ...
    var b = Q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function c(A) {
      {
    ...
    function VA(A, e, i) {
      {
        var r = b.ReactDebugCurrentFrame, I = r.getStackAddendum();
        I !== "" && (e += "%s", i = i.concat([I]));
    ...
    var jA = !1, TA = !1, XA = !1, kA = !1, OA = !1, iA;
    iA = Symbol.for("react.module.reference");
    function ZA(A) {
      return !!(typeof A == "string" || typeof A == "function" || A === B || A === Z || OA || A === O || A === M || A === C || kA || A === Y || jA || TA || XA || typeof A == "object" && A !== null && (A.$$typeof === h || A.$$typeof === d || A.$$typeof === z || A.$$typeof === x || A.$$typeof === o || // This needs to include all possible module reference object
    ...
    function v(A) {
      ...
      if (typeof A == "object")
        switch (A.$$typeof) {
          ...
          case o:
            return YA(A, A.render, "ForwardRef");
          case d:
    ...
    var p = Object.assign, W = 0, EA, tA, IA, nA, aA, sA, uA;
    function lA() {
    }
    ...
    function DA() {
      {
        if (W === 0) {
          EA = console.log, tA = console.info, IA = console.warn, nA = console.error, aA = console.group, sA = console.groupCollapsed, uA = console.groupEnd;
          var A = {
            configurable: !0,
            enumerable: !0,
            value: lA,
    ...
    var G = b.ReactCurrentDispatcher, K;
    function D(A, e, i) {
      {
        if (K === void 0)
          try {
...
`), R = r.stack.split(`
`), s = E.length - 1, u = R.length - 1; s >= 1 && u >= 0 && E[s] !== R[u]; )
            u--;
          for (; s >= 1 && u >= 0; s--, u--)
            if (E[s] !== R[u]) {
              if (s !== 1 || u !== 1)
...
` + E[s].replace(" at new ", " at ");
                    return A.displayName && g.includes("<anonymous>") && (g = g.replace("<anonymous>", A.displayName)), typeof A == "function" && P.set(A, g), g;
                  }
                while (s >= 1 && u >= 0);
              break;
            }
        ...
        U = !1, G.current = a, PA(), Error.prepareStackTrace = I;
      }
    ...
    var S = Object.prototype.hasOwnProperty, cA = {}, RA = b.ReactDebugCurrentFrame;
    function N(A) {
      if (A) {
        var e = A._owner, i = J(A.type, A._source, e ? e.type : null);
        RA.setExtraStackFrame(i);
      } else
        RA.setExtraStackFrame(null);
    }
    function HA(A, e, i, r, I) {
      {
        var a = Function.call.bind(S);
        for (var t in A)
          if (a(A, t)) {
            var E = void 0;
            try {
    ...
    function CA(A) {
      if (UA(A))
        return c("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", KA(A)), fA(A);
    }
    var V = b.ReactCurrentOwner, LA = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ie(A, e, i, r, I) {
      {
        var a, t = {}, E = null, R = null;
        i !== void 0 && (CA(i), E = "" + i), FA(e) && (CA(e.key), E = "" + e.key), qA(e) && (R = e.ref, _A(e, I));
        for (a in e)
          S.call(e, a) && !LA.hasOwnProperty(a) && (t[a] = e[a]);
        if (A && A.defaultProps) {
    ...
    var F = b.ReactCurrentOwner, dA = b.ReactDebugCurrentFrame;
    function y(A) {
      if (A) {
        var e = A._owner, i = J(A.type, A._source, e ? e.type : null);
    ...
    function hA(A, e, i, r, I, a) {
      {
        ...
        if (!t) {
          ...
          R ? E += R : E += vA();
          var s;
          A === null ? s = "null" : L(A) ? s = "array" : A !== void 0 && A.$$typeof === l ? (s = "<" + (v(A.type) || "Unknown") + " />", E = " Did you accidentally export a JSX literal instead of a component?") : s = typeof A, c("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, E);
        }
        var u = ie(A, e, i, I, a);
        if (u == null)
          return u;
...
const Re = "data:image/svg+xml,%3csvg%20width='134'%20height='50'%20viewBox='0%200%20134%2050'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3e%3crect%20width='134'%20height='50'%20fill='url(%23pattern0_2053_338382)'/%3e%3cdefs%3e%3cpattern%20id='pattern0_2053_338382'%20patternContentUnits='objectBoundingBox'%20width='1'%20height='1'%3e%3cuse%20xlink:href='%23image0_2053_338382'%20transform='matrix(0.00115473%200%200%200.00309469%200%20-0.505774)'/%3e%3c/pattern%3e%3cimage%20id='image0_2053_338382'%20width='866'%20height='650'%20xlink:href='data:image/png;base64,'/%3e%3c/defs%3e%3c/svg%3e", fe = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1%2016C1%207.71573%207.71573%201%2016%201C24.2843%201%2031%207.71573%2031%2016C31%2024.2843%2024.2843%2031%2016%2031C7.71573%2031%201%2024.2843%201%2016Z'%20fill='%237F56D9'/%3e%3cpath%20d='M1%2016C1%207.71573%207.71573%201%2016%201C24.2843%201%2031%207.71573%2031%2016C31%2024.2843%2024.2843%2031%2016%2031C7.71573%2031%201%2024.2843%201%2016Z'%20stroke='%237F56D9'%20stroke-width='2'/%3e%3ccircle%20cx='16'%20cy='16'%20r='5'%20fill='white'/%3e%3c/svg%3e", yA = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_2115_1710)'%3e%3cpath%20d='M0%2016C0%207.16344%207.16344%200%2016%200C24.8366%200%2032%207.16344%2032%2016C32%2024.8366%2024.8366%2032%2016%2032C7.16344%2032%200%2024.8366%200%2016Z'%20fill='%23F9FAFB'/%3e%3cpath%20d='M1%2016C1%207.71573%207.71573%201%2016%201C24.2843%201%2031%207.71573%2031%2016C31%2024.2843%2024.2843%2031%2016%2031C7.71573%2031%201%2024.2843%201%2016Z'%20stroke='%23EAECF0'%20stroke-width='2'/%3e%3ccircle%20cx='16'%20cy='16'%20r='5'%20fill='%23D0D5DD'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_2115_1710'%3e%3cpath%20d='M0%2016C0%207.16344%207.16344%200%2016%200C24.8366%200%2032%207.16344%2032%2016C32%2024.8366%2024.8366%2032%2016%2032C7.16344%2032%200%2024.8366%200%2016Z'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e", Ce = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_2115_3819)'%3e%3cpath%20d='M0%2016C0%207.16344%207.16344%200%2016%200C24.8366%200%2032%207.16344%2032%2016C32%2024.8366%2024.8366%2032%2016%2032C7.16344%2032%200%2024.8366%200%2016Z'%20fill='%23F9F5FF'/%3e%3cpath%20d='M1%2016C1%207.71573%207.71573%201%2016%201C24.2843%201%2031%207.71573%2031%2016C31%2024.2843%2024.2843%2031%2016%2031C7.71573%2031%201%2024.2843%201%2016Z'%20fill='%237F56D9'/%3e%3cpath%20d='M1%2016C1%207.71573%207.71573%201%2016%201C24.2843%201%2031%207.71573%2031%2016C31%2024.2843%2024.2843%2031%2016%2031C7.71573%2031%201%2024.2843%201%2016Z'%20stroke='%237F56D9'%20stroke-width='2'/%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M22.7951%209.85346L13.2484%2019.0668L10.7151%2016.3601C10.2484%2015.9201%209.51509%2015.8935%208.98176%2016.2668C8.46176%2016.6535%208.31509%2017.3335%208.63509%2017.8801L11.6351%2022.7601C11.9284%2023.2135%2012.4351%2023.4935%2013.0084%2023.4935C13.5551%2023.4935%2014.0751%2023.2135%2014.3684%2022.7601C14.8484%2022.1335%2024.0084%2011.2135%2024.0084%2011.2135C25.2084%209.9868%2023.7551%208.9068%2022.7951%209.84013V9.85346Z'%20fill='white'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_2115_3819'%3e%3cpath%20d='M0%2016C0%207.16344%207.16344%200%2016%200C24.8366%200%2032%207.16344%2032%2016C32%2024.8366%2024.8366%2032%2016%2032C7.16344%2032%200%2024.8366%200%2016Z'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e", ge = ({
  ...
  return /* @__PURE__ */ n.jsxs("div", { className: "w-full h-[86px] md:gap-[16px] gap-[10px] flex", children: [
    /* @__PURE__ */ n.jsx("div", { className: "w-[32px] flex-shrink-0", children: /* @__PURE__ */ n.jsxs("div", { className: "flex flex-col justify-start items-center", children: [
      B(),
      f === "Active" || f === "Completed" ? /* @__PURE__ */ n.jsx("div", { className: "w-[2px] h-[46px] bgPrimary" }) : /* @__PURE__ */ n.jsx("div", { className: "w-[2px] h-[46px] bgIndicatorColor" })
    ] }) }),
    /* @__PURE__ */ n.jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ n.jsx(
        "div",
        {
          className: `text-[16px] font-[600] ${f === "Active" || f === "Completed" ? "textPrimary" : "textNormal"} `,
          children: Q
        }
      ),
      /* @__PURE__ */ n.jsx(
        "div",
        {
          className: `text-[16px] font-[400] ${f === "Active" || f === "Completed" ? "textSecondry" : "textNormalSec"}`,
          children: l
        }
      )
    ] })
  ] });
}, Qe = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1%208H15M15%208L8%201M15%208L8%2015'%20stroke='white'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e", de = ({}) => {
  const Q = [
    {
      label: "Service",
      detail: "Select issue",
  ...
  return /* @__PURE__ */ n.jsxs("form", { className: "max-w-[960px] w-[100%] h-[738px] bg-white rounded-[24px] md:p-[24px] p-[10px] flex flex-col justify-center items-center md:gap-[24px] gap-[10px]", children: [
    /* @__PURE__ */ n.jsxs("div", { className: "flex md:flex-row flex-col w-full h-full justify-center items-center md:gap-[24px] gap-[10px] border-b border-[#D0D5DD] md:pb-[24px]", children: [
      /* @__PURE__ */ n.jsxs("div", { className: "flex-[0.36] h-full w-full flex flex-col border-r border-[#D0D5DD]", children: [
        /* @__PURE__ */ n.jsx("div", { children: /* @__PURE__ */ n.jsx("img", { src: `${Re}`, alt: "Purple" }) }),
        /* @__PURE__ */ n.jsx("div", { className: "flex flex-col py-[16px]", children: Q.map((l) => /* @__PURE__ */ n.jsx(
          ge,
          {
            detail: l.detail,
            flag: l.flag,
      ...
      /* @__PURE__ */ n.jsxs(
        "button",
        {
          ...
          children: [
            "Next",
            " ",
            /* @__PURE__ */ n.jsx("img", { src: Qe, alt: "arrow", className: "w-[14px] h-[14px] " })
          ]
        }
      )
    ] })
...
function ve() {
  return /* @__PURE__ */ n.jsx("div", { className: "App", children: /* @__PURE__ */ n.jsx("div", { className: "w-[100%] mx-auto h-screen bgBlur flex justify-center items-center", children: /* @__PURE__ */ n.jsx(de, {}) }) });
}
